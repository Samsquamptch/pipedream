...
export default {
  key: "apipie_ai-send-chat",
  name: "Chat",
  version: "0.0.9",
  description: "Send a chat to a selected LLM model. [See the dashboard](https://apipie.ai/dashboard)",
  type: "action",
  props: {
    apipieAi,
    model: {
    ...
    userMessage: {
      type: "string",
      label: "Message",
      description: "The message content sent to the model with the user role. For example 'Why the sky is blue?'",
    },
    maxTokens: {
      propDefinition: [
        apipieAi,
